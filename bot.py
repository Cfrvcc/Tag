...
api_id = int(os.environ.get("2127284"))
api_hash = os.environ.get("dfd91d5d791a9d5ffc4b085d44ed8495")
bot_token = os.environ.get("7342654456:AAGQu5xGVkgkgxrHb68k6dcMoYE1roUYkrU")
